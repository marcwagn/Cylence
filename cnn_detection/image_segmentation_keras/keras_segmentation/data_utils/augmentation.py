...
def _load_augmentation_aug_test():
...
def _load_augmentation_aug_simple():
    return iaa.Sequential([
        ...
        iaa.Sometimes(0.8,iaa.Multiply((0.3, 1.5), per_channel=0.2)),
        #iaa.Sometimes(1,iaa.Multiply((0.6, 1.2), per_channel=0.2)),
        #blur image
...
augmentation_functions = {
    ...
    "simple": _load_augmentation_aug_simple,
    "test": _load_augmentation_aug_test
}
